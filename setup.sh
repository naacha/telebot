...
if [ ! -f ".env" ]; then
    ...
    echo -e "${GREEN}📝 Credentials already integrated:${NC}"
    echo ""
    echo "✅ BOT_TOKEN: 8436081597:AAE-8bfWrbvhl26-l9y65p48DfWjQOYPR2A"
    echo "✅ CHANNEL_ID: -1001802424804 (@ZalheraThink)"
    echo ""
    echo -e "${YELLOW}📝 Still need to configure:${NC}"
    echo "1. BOT_USERNAME - Your bot username (without @)"
...
echo ""
echo -e "${CYAN}🎉 Bot Token and Channel ID already integrated!${NC}"
echo ""
echo -e "${BLUE}📋 Next steps:${NC}"
echo "1. Edit .env file: nano .env (add BOT_USERNAME, Google credentials)"
